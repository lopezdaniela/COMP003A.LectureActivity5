 ...
 * Purpose: methods examples and xml comments 
 */ 
...
static void Main (string[] args)
{
    ...
    Console.WriteLine ($"Multiplication: {Multpily(inputNumber1, inputNumber2)}");
...
static decimal Multpily(decimal num1, decimal num2)
{
    return num1 * num2;
}
